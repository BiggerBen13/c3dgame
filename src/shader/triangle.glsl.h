...
/*
    ...
    Cmdline:
        sokol-shdc --input src/shader/triangle.glsl --output src/shader/triangle.glsl.h --slang glsl300es:glsl410 --format=sokol_impl
...
*/
static const uint8_t vs_source_glsl410[194] = {
